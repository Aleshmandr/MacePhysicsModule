...
namespace MacePhysics.Common
{
    ...
    {
        private readonly PidController[] internalController;
        ...
        public float Kp
        {
            get => this.internalController[0].Kp;
            set
            {
                if (value < 0.0f)
                {
        ...
        public float Ki
        {
            get => this.internalController[0].Ki;
            set
            {
                if (value < 0.0f)
                {
        ...
        public float Kd
        {
            get => this.internalController[0].Kd;
            set
            {
                if (value < 0.0f)
                {
        ...
        /// </returns>
        public Vector3 ComputeRequiredAngularAcceleration(Quaternion currentOrientation, Quaternion desiredOrientation, Vector3 currentAngularVelocity,
            float deltaTime)
        {
